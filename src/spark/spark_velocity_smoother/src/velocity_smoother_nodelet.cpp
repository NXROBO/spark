...
#include <spark_velocity_smoother/paramsConfig.h>

#include <ecl/threads/thread.hpp>

#include "spark_velocity_smoother/velocity_smoother_nodelet.hpp"
...
namespace spark_velocity_smoother {
...
void VelocitySmoother::reconfigCB(spark_velocity_smoother::paramsConfig &config, uint32_t level)
{
...
bool VelocitySmoother::init(ros::NodeHandle& nh)
{
  ...
  dynamic_reconfigure_server = new dynamic_reconfigure::Server<spark_velocity_smoother::paramsConfig>(nh);
...
PLUGINLIB_EXPORT_CLASS(spark_velocity_smoother::VelocitySmootherNodelet, nodelet::Nodelet);
