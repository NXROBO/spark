...
private:
  ...
  ** Dynamic Reconfigure
  **********************/
  dynamic_reconfigure::Server<spark_velocity_smoother::paramsConfig> *             dynamic_reconfigure_server;
  dynamic_reconfigure::Server<spark_velocity_smoother::paramsConfig>::CallbackType dynamic_reconfigure_callback;
  void reconfigCB(spark_velocity_smoother::paramsConfig &config, uint32_t unused_level);
  
};

} // spark_namespace velocity_smoother
