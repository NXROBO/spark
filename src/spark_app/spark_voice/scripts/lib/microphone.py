...
class Microphone:
    ...
    def create_decoder():
        ...
        dict = os.getenv('POCKETSPHINX_DIC', os.path.join(pocketsphinx_data, 'dic.txt'))
        kws = os.getenv('POCKETSPHINX_KWS', os.path.join(pocketsphinx_data, 'cmd.txt'))
