...
#include <tf/tf.h>
#include <fake_spark_base/fake_spark_base_reset_odom.h>
...
void SparkStateSimulation::pubOdom()
{
  ...
  fback_cmd_vel_pub = nh.advertise<geometry_msgs::Twist>("/fback_velocity", 1);
  ...
  ROS_INFO("test feedback velocity");
}
