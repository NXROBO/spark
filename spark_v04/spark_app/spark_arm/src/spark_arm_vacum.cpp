...
private:
  ...
  int x_direction_, y_direction_, z_direction_, vacum_number_;
  double x_max_, y_max_, z_max_;
  ros::Publisher pos_pub_;
  ros::Subscriber joy_sub_;
  ros::Publisher vacum_pub_;
  ...
  z_max_(50)
{
  ...
  vacum_pub_ = ph_.advertise<swiftpro::status>("/pump_topic", 1, true);
}
...
{ 
  ...
  deadman_pressed_ = joy->buttons[vacum_number_];
  swiftpro::status sta;
