...
public:
  ...
  virtual void onInit()
  {
    ...
    std::string resolved_name = ph.getUnresolvedNamespace();  // this always returns like
                                                              // /robosem/goo_arm - why not unresolved?
...
PLUGINLIB_EXPORT_CLASS(follower_velocity_smoother::VelocitySmootherNodelet, nodelet::Nodelet);
