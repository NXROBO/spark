...
{	
	...
	ros::Subscriber sub2 = nh.subscribe("swiftpro_status_topic", 4, swiftpro_status_callback);
	ros::Subscriber sub3 = nh.subscribe("angle4th_topic", 4, angle4th_callback);
	ros::Subscriber sub4 = nh.subscribe("gripper_topic", 4, gripper_callback);
	ros::Subscriber sub5 = nh.subscribe("pump_topic", 4, pump_callback);
