...
openni::Status SampleViewer::init(int argc, char **argv)
{
  ...
  if (m_depthStream.isValid() && m_colorStream.isValid())
  {
    ...
    {
      printf("Error - expect color and depth to be in same resolution: D: "
             "%dx%d, C: %dx%d\n",
...
void SampleViewer::display()
{
  ...
  if ((m_eViewState == DISPLAY_MODE_OVERLAY || m_eViewState == DISPLAY_MODE_IMAGE) && m_colorFrame.isValid())
  {
