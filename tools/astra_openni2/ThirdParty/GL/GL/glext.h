...
GLAPI void APIENTRY
    glTexCoord2fColor3fVertex3fSUN(GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat);
...
GLAPI void APIENTRY
    glReplacementCodeuiNormal3fVertex3fSUN(GLuint, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat, GLfloat);
...
GLAPI void APIENTRY
    glColorFragmentOp2ATI(GLenum, GLuint, GLuint, GLuint, GLuint, GLuint, GLuint, GLuint, GLuint, GLuint);
...
glMultiDrawElementArrayNV(GLenum mode, const GLint *first, const GLsizei *count, GLsizei primcount);
extern void APIENTRY glMultiDrawRangeElementArrayNV(GLenum mode, GLuint start, GLuint end, const GLint *first,
...
typedef void(APIENTRY *PFNGLMULTIDRAWELEMENTARRAYNVPROC)(GLenum mode, const GLint *first, const GLsizei *count,
                                                         GLsizei primcount);
typedef void(APIENTRY *PFNGLMULTIDRAWRANGEELEMENTARRAYNVPROC)(GLenum mode, GLuint start, GLuint end, const GLint *first,
                                                              const GLsizei *count, GLsizei primcount);
#endif
