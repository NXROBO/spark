...
enum
{
  ...
  LINK_PROP_PIXEL_FORMAT = 0x12001001,  // "PixelFormat"
                                        /* Int. 0 - None, 1 - 8z, 2 - 16z, 3 - 24z, 4 - 6-bit, 5 - 10-bit, 6 - 11-bit,
                                           7 - 12-bit */
...
{
  uint32_t count;  // in: number of allocated elements in streams array. out:
...
{
  int streamId;
  uint32_t count;  // in: number of allocated elements in videoModes array. out:
                   // number of written elements in the array
