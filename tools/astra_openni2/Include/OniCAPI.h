...
ONI_C_API OniStatus
oniRegisterDeviceCallbacks(OniDeviceCallbacks *pCallbacks, void *pCookie, OniCallbackHandle *pHandle);
...
ONI_C_API OniStatus oniStreamRegisterNewFrameCallback(OniStreamHandle stream, OniNewFrameCallback handler,
                                                      void *pCookie, OniCallbackHandle *pHandle);
...
ONI_C_API OniStatus oniStreamSetFrameBuffersAllocator(OniStreamHandle stream, OniFrameAllocBufferCallback alloc,
 ...
 * @param	[in]	fileName	The name of the file that will contain the
 * recording.
 * @param	[out]	pRecorder	Points to the handle to the newly created
 * recorder.
 ...
 * @param	[in]	recorder				The handle to the
 * recorder.
 * @param	[in]	stream					The handle to the
 * stream.
 ...
 */
ONI_C_API OniStatus
oniRecorderAttachStream(OniRecorderHandle recorder, OniStreamHandle stream, OniBool allowLossyCompression);
...
ONI_C_API OniStatus oniCoordinateConverterDepthToWorld(OniStreamHandle depthStream, float depthX, float depthY,
                                                       float depthZ, float *pWorldX, float *pWorldY, float *pWorldZ);

ONI_C_API OniStatus oniCoordinateConverterWorldToDepth(OniStreamHandle depthStream, float worldX, float worldY,
                                                       float worldZ, float *pDepthX, float *pDepthY, float *pDepthZ);

ONI_C_API OniStatus oniCoordinateConverterDepthToColor(OniStreamHandle depthStream, OniStreamHandle colorStream,
                                                       int depthX, int depthY, OniDepthPixel depthZ, int *pColorX,
                                                       int *pColorY);
 ...
 * @param	OniBool bConsoleOutput	[in]	TRUE to print log
 ...
 * @param	OniBool bFileOutput	[in]	TRUE to print log entries
 ...
 * @param	OniBool bAndroidOutput	[in]	TRUE to print log
 entries to the Android log, FALSE otherwise.
 *
 * @retval ONI_STATUS_OK Upon successful completion.
 * @retval ONI_STATUS_ERROR Upon any kind of failure.
 */
