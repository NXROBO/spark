...
typedef void(ONI_CALLBACK_TYPE *DeviceStateChangedCallback)(const OniDeviceInfo *deviceId, int errorState,
                                                            void *pCookie);
typedef void(ONI_CALLBACK_TYPE *NewFrameCallback)(StreamBase *streamId, OniFrame *, void *pCookie);
typedef void(ONI_CALLBACK_TYPE *PropertyChangedCallback)(void *sender, int propertyId, const void *data, int dataSize,
                                                         void *pCookie);
...
public:
  ...
  {
    return getServices().getDefaultRequiredFrameSize();
  }
...
protected:
  ...
  {
    (*m_newFrameCallback)(this, pFrame, m_newFrameCallbackCookie);
  }
  void raisePropertyChanged(int propertyId, const void *data, int dataSize)
  {
    (*m_propertyChangedCallback)(this, propertyId, data, dataSize, m_propertyChangedCookie);
  }
...
public:
  ...
  virtual OniStatus initialize(DeviceConnectedCallback connectedCallback,
...
protected:
  ...
  {
    (m_deviceConnectedEvent)(pInfo, m_pCookie);
  }
  void deviceDisconnected(const OniDeviceInfo *pInfo)
  {
    (m_deviceDisconnectedEvent)(pInfo, m_pCookie);
  }
  void deviceStateChanged(const OniDeviceInfo *pInfo, int errorState)
  {
    (m_deviceStateChangedEvent)(pInfo, errorState, m_pCookie);
  }
...
#define ONI_EXPORT_DRIVER(DriverClass)                                                                                 \
  ...
  ONI_C_API_EXPORT OniStatus oniDriverInitialize(oni::driver::DeviceConnectedCallback deviceConnectedCallback,         \
                                                 ...
                                                 void *pCookie)                                                        \
  {                                                                                                                    \
    return g_pDriver->initialize(deviceConnectedCallback, deviceDisconnectedCallback, deviceStateChangedCallback,      \
                                 pCookie);                                                                             \
  }                                                                                                                    \
                                                                                                                       \
  ...
  {                                                                                                                    \
    g_pDriver->deviceClose(pDevice);                                                                                   \
                                                                                                                       ...
                                                                                                                       \
  ONI_C_API_EXPORT OniStatus                                                                                           \
  oniDriverDeviceGetSensorInfoList(oni::driver::DeviceBase *pDevice, OniSensorInfo **pSensorInfos, int *numSensors)    \
  {                                                                                                                    \
  ...
  {                                                                                                                    \
    return pDevice->createStream(sensorType);                                                                          \
                                                                                                                       ...
                                                                                                                       \
  ONI_C_API_EXPORT void oniDriverDeviceDestroyStream(oni::driver::DeviceBase *pDevice,                                 \
                                                     oni::driver::StreamBase *pStream)                                 \
  {                                                                                                                    \
    return pDevice->destroyStream(pStream);                                                                            \
  }                                                                                                                    \
                                                                                                                       \
  ONI_C_API_EXPORT OniStatus                                                                                           \
  oniDriverDeviceSetProperty(oni::driver::DeviceBase *pDevice, int propertyId, const void *data, int dataSize)         \
  {                                                                                                                    \
    return pDevice->setProperty(propertyId, data, dataSize);                                                           \
  }                                                                                                                    \
  ONI_C_API_EXPORT OniStatus                                                                                           \
  oniDriverDeviceGetProperty(oni::driver::DeviceBase *pDevice, int propertyId, void *data, int *pDataSize)             \
  {                                                                                                                    \
  ...
  ONI_C_API_EXPORT void oniDriverDeviceSetPropertyChangedCallback(                                                     \
      oni::driver::DeviceBase *pDevice, oni::driver::PropertyChangedCallback handler, void *pCookie)                   \
  {                                                                                                                    \
  ...
  ONI_C_API_EXPORT OniStatus                                                                                           \
  oniDriverDeviceInvoke(oni::driver::DeviceBase *pDevice, int commandId, void *data, int dataSize)                     \
  {                                                                                                                    \
  ...
  ONI_C_API_EXPORT OniBool                                                                                             \
  oniDriverDeviceIsImageRegistrationModeSupported(oni::driver::DeviceBase *pDevice, OniImageRegistrationMode mode)     \
  {                                                                                                                    \
  ...
  {                                                                                                                    \
    pStream->setServices((oni::driver::StreamServices *)pServices);                                                    \
                                                                                                                       ...
                                                                                                                       \
  ONI_C_API_EXPORT OniStatus                                                                                           \
  oniDriverStreamSetProperty(oni::driver::StreamBase *pStream, int propertyId, const void *data, int dataSize)         \
  {                                                                                                                    \
    return pStream->setProperty(propertyId, data, dataSize);                                                           \
  }                                                                                                                    \
  ONI_C_API_EXPORT OniStatus                                                                                           \
  oniDriverStreamGetProperty(oni::driver::StreamBase *pStream, int propertyId, void *data, int *pDataSize)             \
  {                                                                                                                    \
  ...
  ONI_C_API_EXPORT void oniDriverStreamSetPropertyChangedCallback(                                                     \
      oni::driver::StreamBase *pStream, oni::driver::PropertyChangedCallback handler, void *pCookie)                   \
  {                                                                                                                    \
  ...
  ONI_C_API_EXPORT OniStatus                                                                                           \
  oniDriverStreamInvoke(oni::driver::StreamBase *pStream, int commandId, void *data, int dataSize)                     \
  {                                                                                                                    \
  ...
  {                                                                                                                    \
    pStream->setNewFrameCallback(handler, pCookie);                                                                    \
                                                                                                                       ...
                                                                                                                       \
  ONI_C_API_EXPORT OniStatus oniDriverStreamConvertDepthToColorCoordinates(                                            \
